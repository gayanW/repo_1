package scenes
{
    ...
    public class BenchmarkScene extends Scene
    {
        ...
        public function BenchmarkScene()
        {
            ...
            mStartButton.x = Const.CenterX - int(mStartButton.width / 2);
            mStartButton.y = 20;
        ...
        private function addTestObjects():void
        {
            ...
            for (var i:int = 0; i<numObjects; ++i)
            {
                ...
                egg.x = padding + Math.random() * (Const.GameWidth - 2 * padding);
                egg.y = padding + Math.random() * (Const.GameHeight - 2 * padding);
        ...
        private function benchmarkComplete():void
        {
            ...
            mResultText.x = Const.CenterX - mResultText.width / 2;
            mResultText.y = Const.CenterY - mResultText.height / 2;
